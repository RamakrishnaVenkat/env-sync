    ...
    return (
        <div style={{ backgroundColor: '#f0f2f5' ,display: 'flex', height: '100%' }}>
          <div style={{ flex: '3', backgroundColor: '#f0f2f5', overflowY: 'auto' }} >
            ...
            <div className="flex flex-wrap pl-5 pt-2 ">
                {initiatives.map((initiative, index) => (
                    <InitiationCard
                        ...
                        volunteersRequired={initiative.volunteers}
                    />
                ))}
            </div>

            <div className="flex items-center justify-between px-4 py-2 bg-gray-300 mt-6" style={{ height: '200px', backgroundColor: '#F7B7A9'}}>
                <div>
                    <h2 className="text-5xl font-semibold mt-5 mb-1">Don't wait for someone else.</h2>
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="mx-auto w-[200px] rounded-md border">
            <img
...
export default InitiationAfter;
